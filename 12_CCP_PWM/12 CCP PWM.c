...
#define _XTAL_FREQ 1000000	// The default frequency on reset is 1 MHz.
...
void main (void)
{
    ...
    while(1)
    {
        ...
        __delay_ms(250);    // delay 250ms at peak brightness, just for effect!
        ...
        __delay_ms(250);    // delay 250ms at dimmest, it gives a better effect!
    };    	
}
