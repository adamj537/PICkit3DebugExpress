...
/** V A R I A B L E S *************************************************/
static unsigned char LED_Display;		// 8-bit variable
volatile LEDDirections Direction = LEFT2RIGHT;	// global now to access in Interrupts
...
void interrupt high_priority InterruptServiceHigh(void)
{
